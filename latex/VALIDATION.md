...
Manuscript state: working tree, 2026-07-03 (post peer-review revision + STSR literature + retention update: EKC in the consensus, comparison-data supplementary analysis, transcript regenerated under semanticfa 0.1.2; 71 pp compiled)
...
THREE MORE REFERENCES added 2026-07-03 (retention update; PDFs in papers/, txt in papers_txt/, bib entries built from the PDFs): braeken-vanassen-2017 (EKC source, methods_pipeline + results_retention), ruscio-roche-2012 and goretzko-ruscio-2024 (comparison data / CDF, methods_pipeline + discussion_limitations + discussion_future + supplementary_retention). All three are FIRST-ROUND candidates for the next reference-validation pass. NOTE: Velicer (1976, MAP) and Ruscio & Kaczetow (2008, GenData) are cited in the PACKAGE docs but deliberately NOT in the manuscript yet — their PDFs are not in the library (author to download), and the house rule builds manuscript citations from PDFs only.
