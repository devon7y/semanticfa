...
statement (\valProjNTwCalm). Three upshots follow: prefer keying-free encodings
...
$r_{\text{keyed}} = \valNliRKeyed$)---and report congruence on several metrics
...
semantic criteria disagree (parallel \valPaK, Kaiser \valKaiserK, TEFI \valTefiK, EGA \valEgaK) as
