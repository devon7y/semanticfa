...
Every displayed pair among the eleven (in ten clusters) joins items from
one domain; the simpler cosine criterion (threshold 0.85) flagged a
largely overlapping set of seven pairs in five clusters, led by
N16~$\sim$~N19 (.938) and A24~$\sim$~A29 (.933)---near-paraphrases, the
...
recovery (NMI .527 to .810; ARI .402 to .571): pruning semantically
peripheral items sharpens boundaries the full pool blurs. Parallel
analysis now suggested three factors; per the printed caveat, a semantic
...
(Extraversion vs.\ Neuroticism gap .01), near-duplication of E1 (cosine
.90, above the .85 cutoff), and a weaker match to its best construct
