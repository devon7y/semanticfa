...
analysis suggested \valHumanPaKWord---at $N = \valNHuman$ even trivial factors
...
MR2 0.27  0.11 0.10 0.84 0.28
MR5 0.41 -0.01 0.52 0.05 0.27
MR4 0.64  0.07 0.52 0.11 0.16
MR1 0.18  0.02 0.17 0.14 0.92
...
strongly ($\phi = \valPhiO$, \valPhiC, \valPhiN); Extraversion (\valPhiE) and Agreeableness
(\valPhiA) weakly, the former matching human Agreeableness nearly as well
(\valPhiEA). Overall, $\bar{\phi} = \valPhiMean$, NMI = \valNmiTheory, ARI = \valAriTheory, and
...
raw correlations of \valNHuman{} respondents at $r = \valPairR$
