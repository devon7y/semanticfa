...
domain---N12 sits nearer the Extraversion centroid (\valAnchorNTwRival) than its own
(\valAnchorNTwOwn); label anchoring (same Qwen3-Embedding-8B space) flagged an
overlapping set, A25 lowest (own \valAnchorATwFiveOwn{} vs.\ \valAnchorATwFiveNeur{} on Neuroticism), then E6,
A27, C36, N12, and C32.
...
anxious pole, yet the most calm-pole item (\valProjNTwCalm) is again reverse-keyed
