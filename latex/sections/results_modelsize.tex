...
and 8B (4,096). The mean-centered Pearson similarity matrix was built
...
consensus is \valConsensusKWord{} (the eigenvalue-greater-than-one rule reports \valKaiserKWord, the
empirical Kaiser criterion \valEkcKLargeWord, and TEFI
...
the package's on-device default remains the lighter 0.6B model. The
comparison-data misfit profiles of the same three matrices, and their
contrast with the human benchmark, are reported in the Supplementary
Materials.
