...
embeddings the criteria disagree---parallel analysis retains four factors,
EGA six, for a modal consensus of six---whereas under the 8B embeddings
parallel analysis and EGA converge on the theoretical five, and the
consensus is five (the eigenvalue-greater-than-one rule reports six and TEFI
two at every size). Larger models of the same family thus yield semantic
