...
sentence-BERT embeddings, so you can try it with zero setup:
...
SQuID and mean-centered Pearson recover negative correlations between
reverse-keyed dimensions — atomic_reversed does not.
...
emb <- sfa_embed(my_items, embed = "sbert", model = "all-MiniLM-L6-v2")
